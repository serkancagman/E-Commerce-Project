    ...
    <div className="col-md-9 h-100 col-lg-9">
        ...
        <div className="row g-3 flex-wrap my-3">
          <div className="col-md-4 col-lg-4">
            <div className="profileItemNav">
              <Link to="/" className="profileLinkNav">
                <MdPersonPin className="profileIcon" /> Information
              </Link>
            </div>
          </div>
          <div className="col-md-4 col-lg-4">
            <div className="profileItemNav">
              <Link to="/" className="profileLinkNav">
                <BiLocationPlus className="profileIcon" /> Add first address
              </Link>
            </div>
          </div>
          <div className="col-md-4 col-lg-4">
            <div className="profileItemNav">
              <Link to="/" className="profileLinkNav">
                <BsCalendarMinus className="profileIcon" /> Order history and
                details
              </Link>
            </div>
          </div>
          <div className="col-md-4 col-lg-4">
            <div className="profileItemNav">
              <Link to="/" className="profileLinkNav">
                <RiBillLine className="profileIcon" /> Credit slips
              </Link>
            </div>
          </div>
          <div className="col-md-4 col-lg-4">
            <div className="profileItemNav">
              <Link to="/" className="profileLinkNav">
                <BsFillFilePersonFill className="profileIcon" /> GDPR - Personal
                data
              </Link>
            </div>
          </div>
      ...
      <div className="profileFooter d-flex align-items-center justify-content-between p-3">
        <div className="returnProfile">
          <Link to="/" className="returnProfileLink">
