        ...
        <div className="row">
          ...
          <div className="col-lg-12">
              <div className={addressStyle.billAddressCheckBox}>
                <Form.Item >
                  <Checkbox name="billCheckbox" onChange={(value) =>handleCheckbox(value.target.checked)}> Send my bill to another address.</Checkbox> 
                </Form.Item>
              </div>
          </div>
          {checkedBill && (
          ...
          <div className="col-lg-12">
            <div className={addressStyle.addressButtons}>
              <Button className={addressStyle.checkoutBackBtn}>Back to Check Products</Button>
              <Button className={`mx-1 ${addressStyle.continueBtn}`}>Save Address & Continue</Button>
            </div>
          </div>
        </div>
      </Form>
